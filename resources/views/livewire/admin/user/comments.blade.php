<div>
  <div wire:poll.10s>
          ...
          <div
            ...
            <div>
              <div class="flex flex-wrap gap-2 gap-y-0">
                <p class="flex items-center lg:text-sm text-xs text-slate-800 dark:text-slate-200 whitespace-nowrap">
                  {{ $comment->user->name() }}</p>
              ...
              <p class="mt-1 lg:text-sm text-xs text-slate-800 dark:text-slate-200 whitespace-nowrap">
                <strong>محصول:</strong> {{ $comment->product->name }}
              </p>
              <p class="mt-1 lg:text-sm text-xs text-slate-800 dark:text-slate-200 whitespace-nowrap">
                <strong>متن:</strong>
              </p>
    ...
    @if ($comments && count($comments) > 0)
      ...
      @endforeach
    @else
      <p class="text-redy text-center">کامنتی برای این کاربر وجود ندارد!</p>
    @endif
