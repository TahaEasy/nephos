<div x-data='ToastComponent($wire)' @mouseleave="scheduleRemovalWithOlder()"
  class="fixed bottom-0 z-50 p-4 space-y-3 w-full max-w-sm pointer-events-none left-1/2 sm:left-0 -translate-x-1/2 sm:translate-x-0 toasts-container sm:p-6"
  style="z-index:999;">
