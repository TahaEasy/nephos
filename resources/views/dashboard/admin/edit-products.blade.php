<x-admin-dashboard-layout header="مدیریت سفارشات">
  <div>
        ...
        <div
          ...
          <div class="flex flex-col justify-start bg-slate-50 dark:bg-slate-700/40 border-b-[1px] border-b-gray-400/50">
            <div class="flex justify-between items-center p-4 py-3">
              ...
              <a href="
              @if (url()->previous() === route('admin.user.products', ['user' => $product->user->id])) {{ route('admin.user.products', ['user' => $product->user->id]) }}
              ...
              @else {{ route('admin.products') }} @endif
              "
