<svg id="eC1L7s54vZU1" width="{{ $w }}" height="{{ $h }}" xmlns="http://www.w3.org/2000/svg"
  xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-49 141 550 550" shape-rendering="geometricPrecision"
  text-rendering="geometricPrecision" class="glow-primary">
  <g transform="translate(18.99997 19)">
    <path id="eC1L7s54vZU3"
      d="M428.7,525v-256L207,141L-14.7,269v256L207,653L428.7,525ZM75.8,321.3L207,245.6l131.2,75.7v151.4L207,548.4L75.8,472.7v-151.4Z"
      class="fill-primary" fill="currentColor" />
    <path id="eC1L7s54vZU4" d="M207,469.6l-62.9-36.3v-72.6L207,324.4l62.9,36.3v72.6L207,469.6Z" class="fill-primary"
      fill="currentColor" />
  </g>
  <script>
    <![CDATA[
    ! function(t, n) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = n() : "function" ==
        typeof __SVGATOR_DEFINE__ && __SVGATOR_DEFINE__.amd ? __SVGATOR_DEFINE__(n) : ((t = "undefined" !=
            typeof globalThis ? globalThis : t || self).__SVGATOR_PLAYER__ = t.__SVGATOR_PLAYER__ || {}, t
          .__SVGATOR_PLAYER__["5c7f360c"] = n())
    }(this, (function() {
      "use strict";
      ...
      function k() {
        ...
        return t < 0 || t > 1 || e < 0 || e > 1 ? null : m(t, n) && m(e, r) ? _ : function(i) {
          ...
          return u(t, [{
            ...
            value: function() {
              ...
              if (t %= 360) {
                ...
                var n = M(t),
                  ...
                  i = r[0],
                  u = r[1];
                r[0] = i * e + r[2] * n, r[1] = u * e + r[3] * n, r[2] = r[2] * e - i * n, r[3] = r[3] * e -
                  u * n, this.w = this.s = this.i = null
              }
              return this
            }
          }, {
            ...
            value: function(t, n) {
              if (n %= 360, (t %= 360) || n) {
                var e = this.m,
                  ...
                  u = e[2],
                  o = e[3];
                t && (t = R(w(t)), e[2] += r * t, e[3] += i * t), n && (n = R(w(n)), e[0] += u * n, e[1] +=
            ...
            value: function() {
              var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                ...
                o = this.m;
              return o[0] = t, o[1] = n, o[2] = e, o[3] = r, o[4] = i, o[5] = u, this.w = this.s = this.i =
                null, this
            }
          }, {
            key: "recomposeSelf",
            ...
            value: function() {
              ...
              return 0 === s ? {
                ...
                rotate: 0
              } : (i[1][0] /= s, i[1][1] /= s, a /= s, i[1][1] < 0 ? (l = x(P(i[1][1])), i[0][1] < 0 && (l =
                360 - l)) : l = x(I(i[0][1])), o && (l = -l), a = x(F(a, N(i[0][0] * i[0][0] + i[0][1] *
                i[0][1]))), o && (a = -a), {
                origin: {
                  x: d(e[4]),
                  y: d(e[5])
            ...
            value: function() {
              ...
              if (null === this.s) {
                ...
                1 === n[0] && 0 === n[1] && 0 === n[2] && 1 === n[3] ? this.s = "translate(" + n[4] + t + n[
                  5] + ")" : this.s = "matrix(" + n.join(t) + ")"
              }
              return this.s
            }
          }], [{
            key: "create",
            value: function(t) {
              return t ? Array.isArray(t) ? f(this, v(t)) : t instanceof this ? t.clone() : (new this)
                .recomposeSelf(t.origin, t.rotate, t.skew, t.scale, t.translate) : new this
            }
          }]), t
        }();
      ...
      function K(t) {
        return t ? "function" == typeof t ? t : Array.isArray(t) ? function(t) {
          ...
          var e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : _;
          switch (t) {
            case "linear":
              return _;
            case "steps":
            ...
            case "bezier":
            case "cubic-bezier":
              return k(n.x1 || 0, n.y1 || 0, n.x2 || 0, n.y2 || 0) || e
          }
          return e
      ...
      function W(t, n, e) {
        ...
        return null == a ? r ? [i, 1, n[i].v] : n[i].v : o.t === a.t ? r ? [u, 1, a.v] : a.v : (t = (t - o.t) / (a.t -
          o.t), o.e && (t = o.e(t)), r ? [u, t, e(t, o.v, a.v)] : e(t, o.v, a.v))
      }
      ...
      function nt(t, n, r, i, u) {
        var o, a = "@" === r[0],
          ...
          s = U[r],
          f = B;
        switch (a ? (o = r.substr(1), r = o.replace(H, J)) : l && (r = r.substr(1)), e(s)) {
          case "function":
          ...
          case "string":
            ...
            break;
          case "object":
            if ((f = X(i, Z(s.i), s.f)) && "function" == typeof s.u) return s.u(n, f, r, a, t)
        }
      ...
      function ot(t) {
        ...
        return document ? Array.from(t.querySelectorAll(":not(" + ["a", "area", "audio", "br", "canvas", "circle",
          "datalist", "embed", "g", "head", "hr", "iframe", "img", "input", "link", "object", "path", "polygon",
          "rect", "script", "source", "style", "svg", "title", "track", "video"
        ].join() + ")")).filter(n).map(n) : []
      }
      ...
      function ft(t, n, e) {
        return !t || !e || n > t.length ? t : t.substring(0, n) + ft(t.substring(n + 1), e, e)
      }

      function ct(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 27;
        return !t || t % n ? t % n : [0, 1].includes(n) ? n : ct(t / n, n)
      }
      ...
      function ht(t, n, e) {
        if (t && t.length) {
          ...
          return u = u.replace(/\x7c$/g, "==").replace(/\x2f$/g, "="), u = function(t, n, e) {
            ...
            t = t.substring(4);
            for (var i = st(n, r) % r + e % 27, u = [], o = 0; o < t.length; o += 2)
              if ("|" !== t[o]) {
      ...
      var vt = [{
        ...
        yt = function() {
          function t(n, e) {
            ...
            r(this, t), this._id = 0, this._running = !1, this._rollingBack = !1, this._animations = n, this
              ._settings = e, (!u || u < "2022-05-02") && delete this._settings.speed, vt.forEach((function(t) {
          ...
          return u(t, [{
            ...
            key: "_apply",
            value: function(t) {
              for (var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, e = this
                  ._animations, r = e.length, i = 0, u = 0; u < r; u++) n[u] ? i++ : (n[u] = e[u](t, 1), n[
                u] && i++);
              return i
            }
          }, {
            ...
            value: function() {
              ...
              var u = function u(o) {
                ...
                if (a >= e + l && !t._rollingBack && (t.offset = a, e = a, t._apply(a, i) === t._animations
                    .length)) return void t.pause(!0);
            ...
            key: "play",
            value: function() {
              if (!this._running) return this._rollingBack ? this._rollback(this.offset) : this._start(this
                .offset)
            }
          }, {
            key: "stop",
            value: function() {
              this._pause(), this.offset = 0, this.rollbackStartOffset = 0, this._rollingBack = !1, this
                ._apply(0)
            }
          }, {
            key: "reachedToEnd",
            ...
            key: "build",
            value: function(t, n) {
              delete t.animationSettings, t.options = ht(t.options, t.root, "5c7f360c"), t.animations.map((
                function(n) {
                  n.settings = ht(n.s, t.root, "5c7f360c"), delete n.s, t.animationSettings || (t
      ...
      function mt(t) {
        ...
        for (var t = 0, n = ["ms", "moz", "webkit", "o"], e = 0; e < n.length && !window.requestAnimationFrame; ++e)
          window.requestAnimationFrame = window[n[e] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[
            n[e] + "CancelAnimationFrame"] || window[n[e] + "CancelRequestAnimationFrame"];
      ...
      var bt = {
          ...
          u: function(t, n) {
            return function(e) {
              var r = n(e);
              t.setAttribute("rx", gt(r.x)), t.setAttribute("ry", gt(r.y))
            }
          }
        },
        wt = {
          ...
          u: function(t, n) {
            return function(e) {
              var r = n(e);
              t.setAttribute("width", gt(r.width)), t.setAttribute("height", gt(r.height))
            }
          }
        };
      Object.freeze({
      ...
      function At(t) {
        var n = function() {
          if (_t) return _t;
          if ("object" !== ("undefined" == typeof document ? "undefined" : e(document)) || !document
            .createElementNS) return {};
          var t = document.createElementNS("http://www.w3.org/2000/svg", "svg");
          return t && t.style ? (t.style.position = "absolute", t.style.opacity = "0.01", t.style.zIndex = "-9999",
            t.style.left = "-9999px", t.style.width = "1px", t.style.height = "1px", _t = {
              svg: t
            }) : {}
        }().svg;
        ...
        r.setAttributeNS(null, "d", t), r.setAttributeNS(null, "fill", "none"), r.setAttributeNS(null, "stroke",
      ...
      function Bt(t, n, e, r, i) {
        return Math.atan2(Tt(t.y, n.y, e.y, r.y, i), Tt(t.x, n.x, e.x, r.x, i))
      }
      ...
      function Dt(t, n, e) {
        ...
        if (Ct(n)) {
          ...
          if (Gt(n)) return Vt(e) ? qt(n, n.end, e.start, e, t, r) : Rt(n, n.end, e, t, r);
          if (Vt(e)) return Rt(n, e.start, e, t, r)
        }
        return Mt(n, e, t, r)
      }
      ...
      function Ht(t, n, r, i, u, o, a, l) {
        return Ut(t, 0, l), n = function(t, n, e) {
            for (var r, i, u, o = t.length - 1, a = {}, l = 0; l <= o; l++)(r = t[l]).e && (r.e = n(r.e)), r.v &&
              "g" === (i = r.v).t && i.r && (u = e.getElementById(i.r)) && (a[i.r] = {
                e: u,
            ...
            if ("g" === u.t) {
              ...
              return function(t, n) {
                for (var e = t.s, r = e.length; r < n.length; r++) {
                  ...
                  i.id = Wt(i.id), t.e.appendChild(i), e = t.s = t.e.querySelectorAll("stop")
                }
                for (var u = 0, o = e.length, a = n.length - 1; u < o; u++) e[u].setAttribute("stop-color", dt(n[
                  Math.min(u, a)].c)), e[u].setAttribute("offset", n[Math.min(u, a)].o)
              }(o, u.s), Object.keys(Qt).forEach((function(t) {
                if (void 0 !== u[t])
                  if ("object" !== e(Qt[t])) {
                    var n, r = "gt" === t ? (n = u[t], Array.isArray(n) ? "matrix(" + n.join(" ") + ")" : "") :
                      u[t],
                      i = Qt[t];
                    o.e.setAttribute(i, r)
                  } else Object.keys(Qt[t]).forEach((function(n) {
                    if (void 0 !== u[t][n]) {
                      var e = u[t][n],
                        r = Qt[t][n];
      ...
      function Jt(t, e, r) {
        ...
        if (e && r) {
            ...
            case "g":
              if (e.r === r.r) {
                ...
                return e.gt && r.gt && (u.gt = function(t, n, e) {
                  var r = n.length;
                  if (r !== e.length) return B(t, n, e);
                  for (var i = new Array(r), u = 0; u < r; u++) i[u] = D(t, n[u], e[u]);
                  return i
                }(t, e.gt, r.gt)), e.c ? (u.c = V(t, e.c, r.c), u.rd = L(t, e.rd, r.rd)) : e.f && (u.f = V(t, e.f,
                  r.f), u.to = V(t, e.to, r.to)), u
              }
          }
          if ("c" === e.t && "g" === r.t || "c" === r.t && "g" === e.t) {
            ...
            return a.s = "c" === e.t ? Zt(t, l, a.s) : Zt(t, a.s, l), a
          }
        }
        return B(t, e, r)
      }
      ...
      function Zt(t, n, e) {
        ...
        for (var r = Math.max(n.length, e.length), i = [], u = 0; u < r; u++) {
          var o = Kt(t, n[Math.min(u, n.length - 1)], e[Math.min(u, e.length - 1)]);
          i.push(o)
        }
        return i
      }
      ...
      var Xt = {
          ...
          "stroke-dasharray": {
            ...
            i: function(t, n, e) {
              ...
              for (var s = [], f = 0; f < o; f++) s.push(d(L(t, n[f], e[f])));
              return s
            }
          },
          opacity: $t,
          transform: function(t, n, r, i) {
            ...
            return n && n.a && t.o ? function(n) {
              var e = r(n, t.o, Lt);
              return zt.recomposeSelf(e, u("r", n, D, 0) + e.a, u("k", n, V), u("s", n, V), u("t", n, V))
                .toString()
            } : function(t) {
              return zt.recomposeSelf(u("o", t, Dt, null), u("r", t, D, 0), u("k", t, V), u("s", t, V), u("t", t,
                V)).toString()
            }
          },
          r: Yt,
        ...
        tn = function(t) {
          ...
          return u(o, null, [{
            key: "build",
            value: function(t) {
              var n = h(a(o), "build", this).call(this, t, Xt);
              if (!n) return null;
              n.el, n.options,
                function(t, n, e) {
                  t.play()
    ...
    (function(s, i, o, w, d, a, b) {
      ...
      "animations": [{
        ...
        "s": ""
      }],
      "options": "MIDAxMDg4MmY4MEU4MTPZlN2Y4MTJmNDcyZkUP3OTdjNmU3MTJmVThhF"
